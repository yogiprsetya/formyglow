...
import { Sparkles, Shield, Heart, Sparkles as SparklesIcon } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">FormyGlow</h1>
          </div>
          <p className="text-lg text-gray-600 dark:text-gray-300">Your Personal Skincare Assistant</p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-4">
          <div className="flex items-center space-x-3 text-sm text-gray-600 dark:text-gray-400">
            ...
            <span>Ingredient safety checks</span>
          </div>
          <div className="flex items-center space-x-3 text-sm text-gray-600 dark:text-gray-400">
